...
public class UpdateCarServiceItemReqVO extends BaseRequest{

    private static final long serialVersionUID = 7218778370152326861L;
    /**
     * 主键
     */
    @AutoDocProperty(value = "serviceId", required = true)
     ...
     */
    @AutoDocProperty(value = "服务分类 1保养 2美容 3养护 4清洗套餐 5年检 6车辆检测 7维修", required = true)
     ...
     * 是否有效
     */
    @AutoDocProperty(value = "是否有效",required = true)
