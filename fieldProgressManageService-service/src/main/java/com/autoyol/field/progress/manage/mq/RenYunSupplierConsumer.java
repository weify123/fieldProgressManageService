...
@Component
public class RenYunSupplierConsumer extends AbstractConsumer{

    @Resource(name = "renYunSyncFieldSupplierProcess")
    TaskProcess taskProcess;

    @Override
    @RabbitListener(queues = CacheConstraint.sqlServer_supplier_mq_queue, containerFactory = "rabbitListenerContainerFactory")
