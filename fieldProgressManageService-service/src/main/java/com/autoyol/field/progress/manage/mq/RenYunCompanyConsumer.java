...
@Component
public class RenYunCompanyConsumer extends AbstractConsumer{

    @Resource(name = "renYunSyncFieldProcess")
    TaskProcess taskProcess;

    @Override
    @RabbitListener(queues = CacheConstraint.sqlServer_company_mq_queue, containerFactory = "rabbitListenerContainerFactory")
