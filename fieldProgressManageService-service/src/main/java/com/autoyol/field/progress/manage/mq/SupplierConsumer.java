...
import static com.autoyol.field.progress.manage.mq.MQConstraint.AUTO_SUPPLIER_OPR_QUEUE;

@Component
public class SupplierConsumer extends AbstractConsumer{

    @Resource(name = "supplierOprProcess")
    TaskProcess taskProcess;

    @Override
    @RabbitListener(queues = AUTO_SUPPLIER_OPR_QUEUE, containerFactory = "rabbitListenerContainerFactory")
